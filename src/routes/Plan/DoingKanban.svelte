<script>
  import KanbanCell from './KanbanCell.svelte'  // TODO: Get rid of KanbanCell and merge it into this code if we want the crossfade (make it move) animation to work
